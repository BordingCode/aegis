...
// --- Act II: the Underworld (battle backdrop = the Gates of Hades; tough roster) ---
const UW = (o) => makeLevel({ ...o, bg: 'backgrounds/act3.webp', enemyAct: 3 });
const UNDERWORLD = [
  { id: 'styx', name: 'The Crossing of the Styx', type: 'defense', pos: { x: 22, y: 70 }, requires: [],
    level: UW({ id: 'u_styx', act: 2, name: 'The Crossing of the Styx', D: 8, scale: 2.4, W: 7, favorStart: 90, reward: 40 }), reward: { meta: 40 },
  ...
  { id: 'cerberus_gate', name: 'The Gate of Cerberus', type: 'boss', pos: { x: 40, y: 56 }, requires: ['styx'],
    level: UW({ id: 'u_cerb', act: 2, name: 'The Gate of Cerberus', mode: 'boss', target: { kind: 'boss', bossId: 'cerberus', hp: 3200 }, relic: 'winged_sandals', D: 6, scale: 2.2, W: 6, favorStart: 110, favorMax: 620, reward: 70 }), reward: { meta: 70, relic: 'winged_sandals' },
  ...
  { id: 'asphodel', name: 'The Fields of Asphodel', type: 'assault', pos: { x: 36, y: 32 }, requires: ['styx'],
    level: UW({ id: 'u_asph', act: 2, name: 'The Fields of Asphodel', mode: 'assault', target: { kind: 'stronghold', hp: 2600 }, D: 8, scale: 2.6, W: 7, favorStart: 120, favorMax: 620, reward: 52 }), reward: { meta: 52 },
  ...
  { id: 'tartarus', name: 'The Pit of Tartarus', type: 'defense', pos: { x: 60, y: 64 }, requires: ['cerberus_gate'],
    level: UW({ id: 'u_tart', act: 2, name: 'The Pit of Tartarus', D: 10, scale: 3.0, W: 8, favorStart: 100, favorMax: 620, reward: 56 }), reward: { meta: 56 },
  ...
  { id: 'lethe', name: 'The Banks of Lethe', type: 'assault', pos: { x: 58, y: 28 }, requires: ['asphodel'],
    level: UW({ id: 'u_lethe', act: 2, name: 'The Banks of Lethe', mode: 'assault', target: { kind: 'stronghold', hp: 3000 }, D: 9, scale: 3.0, W: 7, favorStart: 120, favorMax: 660, reward: 58 }), reward: { meta: 58 },
  ...
  { id: 'hydra_depths', name: 'The Hydra of the Depths', type: 'boss', pos: { x: 80, y: 46 }, requires: ['tartarus', 'lethe'],
    level: UW({ id: 'u_hydra', act: 2, name: 'The Hydra of the Depths', mode: 'boss', target: { kind: 'boss', bossId: 'hydra', hp: 5200 }, relic: 'medusa_gaze', D: 9, scale: 3.0, W: 8, favorStart: 130, favorMax: 700, reward: 120 }), reward: { meta: 120, relic: 'medusa_gaze' }, realmEnd: true,
    blurb: 'The many-headed serpent guards the way up. Fell it, and Olympus opens.' },
];

// --- Act III: Olympus (radiant backdrop; the toughest roster) ---
const OL = (o) => makeLevel({ ...o, bg: 'backgrounds/act2.webp', enemyAct: 3 });
const OLYMPUS = [
  { id: 'ascent', name: 'The Cloudward Ascent', type: 'assault', pos: { x: 30, y: 80 }, requires: [],
    level: OL({ id: 'o_ascent', act: 3, name: 'The Cloudward Ascent', mode: 'assault', target: { kind: 'stronghold', hp: 3400 }, D: 9, scale: 3.4, W: 7, favorStart: 120, favorMax: 700, reward: 60 }), reward: { meta: 60 },
  ...
  { id: 'gigantomachy', name: 'The Gigantomachy', type: 'defense', pos: { x: 48, y: 60 }, requires: ['ascent'],
    level: OL({ id: 'o_giant', act: 3, name: 'The Gigantomachy', D: 12, scale: 4.0, W: 8, favorStart: 110, favorMax: 740, reward: 70 }), reward: { meta: 70 },
  ...
  { id: 'titan', name: 'The Chained Titan', type: 'boss', pos: { x: 28, y: 46 }, requires: ['ascent'],
    level: OL({ id: 'o_titan', act: 3, name: 'The Chained Titan', mode: 'boss', target: { kind: 'boss', bossId: 'cyclops', hp: 5000 }, relic: 'phalanx_discipline', D: 9, scale: 3.8, W: 7, favorStart: 130, favorMax: 740, reward: 110 }), reward: { meta: 110, relic: 'phalanx_discipline' },
  ...
  { id: 'pantheon', name: 'The Hall of the Gods', type: 'defense', pos: { x: 56, y: 34 }, requires: ['gigantomachy'],
    level: OL({ id: 'o_hall', act: 3, name: 'The Hall of the Gods', D: 14, scale: 4.6, W: 9, favorStart: 110, favorMax: 780, reward: 80 }), reward: { meta: 80 },
  ...
  { id: 'typhon', name: 'Typhon, Father of Monsters', type: 'boss', pos: { x: 70, y: 18 }, requires: ['titan', 'pantheon'],
    level: OL({ id: 'o_typhon', act: 3, name: 'Typhon, Father of Monsters', mode: 'boss', target: { kind: 'boss', bossId: 'typhon', hp: 7800 }, relic: 'bolt_of_olympus', D: 12, scale: 4.4, W: 9, favorStart: 140, favorMax: 820, reward: 250 }), reward: { meta: 250, relic: 'bolt_of_olympus' }, realmEnd: true,
