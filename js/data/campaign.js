...
const UNDERWORLD = [
  ...
  { id: 'lethe', name: 'The Banks of Lethe', type: 'assault', pos: { x: 58, y: 28 }, requires: ['asphodel'],
    level: UW({ id: 'u_lethe', act: 2, name: 'The Banks of Lethe', mode: 'assault', target: { kind: 'stronghold', hp: 1900 }, D: 5, scale: 1.3, W: 7, favorStart: 125, favorMax: 680, reward: 58 }), reward: { meta: 58 },
...
const OLYMPUS = [
  ...
  { id: 'pantheon', name: 'The Hall of the Gods', type: 'defense', pos: { x: 56, y: 34 }, requires: ['gigantomachy'],
    level: OL({ id: 'o_hall', act: 3, name: 'The Hall of the Gods', D: 5, scale: 1.3, W: 8, favorStart: 125, favorMax: 800, reward: 80 }), reward: { meta: 80 },
